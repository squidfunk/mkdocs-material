...
(() => {
  ...
  ***************************************************************************** */
  ...
  (() => {
    ...
    function c(...i) {
      return i.reduce((e, r) => e.then(() => new Promise((t) => {
        let o = document.createElement("script");
        o.src = r, o.onload = t, document.body.appendChild(o);
      })), Promise.resolve());
    }
    var n = class {
      constructor(e) {
        ...
        this.e = (e2, r2, t2, o, s) => {
          if (r2 === this.url.toString()) {
            let a = new ErrorEvent("error", { message: e2, filename: r2, lineno: t2, colno: o, error: s });
            this.dispatchEvent(a), this.onerror && this.onerror(a);
          }
        };
        let r = new EventTarget();
        this.addEventListener = r.addEventListener.bind(r), this.removeEventListener = r.removeEventListener.bind(r), this.dispatchEvent = r.dispatchEvent.bind(r);
