 ...
 */t.stemmer=function(){var e={ational:"ate",tional:"tion",enci:"ence",anci:"ance",izer:"ize",bli:"ble",alli:"al",entli:"ent",eli:"e",ousli:"ous",ization:"ize",ation:"ate",ator:"ate",alism:"al",iveness:"ive",fulness:"ful",ousness:"ous",aliti:"al",iviti:"ive",biliti:"ble",logi:"log"},r={icate:"ic",ative:"",alize:"al",iciti:"ic",ical:"ic",ful:"",ness:""},n="[^aeiou]",i="[aeiouy]",s=n+"[^aeiouy]*",o=i+"[aeiou]*",a="^("+s+")?"+o+s,u="^("+s+")?"+o+s+"("+o+")?$",c="^("+s+")?"+o+s+o+s,h="^("+s+")?"+i,y=new RegExp(a),g=new RegExp(c),b=new RegExp(u),v=new RegExp(h),Q=/^(.+?)(ss|i)es$/,p=/^(.+?)([^s])s$/,d=/^(.+?)eed$/,L=/^(.+?)(ed|ing)$/,w=/.$/,k=/(at|bl|iz)$/,I=new RegExp("([^aeiouylsz])\\1$"),j=new RegExp("^"+s+i+"[^aeiouwxy]$"),C=/^(.+?[^aeiou])y$/,A=/^(.+?)(ational|tional|enci|anci|izer|bli|alli|entli|eli|ousli|ization|ation|ator|alism|iveness|fulness|ousness|aliti|iviti|biliti|logi)$/,$=/^(.+?)(icate|ative|alize|iciti|ical|ful|ness)$/,D=/^(.+?)(al|ance|ence|er|ic|able|ible|ant|ement|ment|ent|ou|ism|ate|iti|ous|ive|ize)$/,V=/^(.+?)(s|t)(ion)$/,T=/^(.+?)e$/,N=/ll$/,B=new RegExp("^"+s+i+"[^aeiouwxy]$"),M=function(l){var m,P,E,f,x,R,_;if(l.length<3)return l;if(E=l.substr(0,1),E=="y"&&(l=E.toUpperCase()+l.substr(1)),f=Q,x=p,f.test(l)?l=l.replace(f,"$1$2"):x.test(l)&&(l=l.replace(x,"$1$2")),f=d,x=L,f.test(l)){var S=f.exec(l);f=y,f.test(S[1])&&(f=w,l=l.replace(f,""))}else if(x.test(l)){var S=x.exec(l);m=S[1],x=v,x.test(m)&&(l=m,x=k,R=I,_=j,x.test(l)?l=l+"e":R.test(l)?(f=w,l=l.replace(f,"")):_.test(l)&&(l=l+"e"))}if(f=C,f.test(l)){var S=f.exec(l);m=S[1],l=m+"i"}if(f=A,f.test(l)){var S=f.exec(l);m=S[1],P=S[2],f=y,f.test(m)&&(l=m+e[P])}if(f=$,f.test(l)){var S=f.exec(l);m=S[1],P=S[2],f=y,f.test(m)&&(l=m+r[P])}if(f=D,x=V,f.test(l)){var S=f.exec(l);m=S[1],f=g,f.test(m)&&(l=m)}else if(x.test(l)){var S=x.exec(l);m=S[1]+S[2],x=g,x.test(m)&&(l=m)}if(f=T,f.test(l)){var S=f.exec(l);m=S[1],f=g,x=b,R=B,(f.test(m)||x.test(m)&&!R.test(m))&&(l=m)}return f=N,x=g,f.test(l)&&x.test(l)&&(f=w,l=l.replace(f,"")),E=="y"&&(l=E.toLowerCase()+l.substr(1)),l};return function(O){return O.update(M)}}(),t.Pipeline.registerFunction(t.stemmer,"stemmer");/*!
 * lunr.stopWordFilter
 * Copyright (C) 2020 Oliver Nightingale
