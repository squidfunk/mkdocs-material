...
(() => {
  ...
  ***************************************************************************** */
  ...
  var Observable = function() {
    function Observable53(subscribe) {
      if (subscribe) {
        this._subscribe = subscribe;
      }
    }
    Observable53.prototype.lift = function(operator) {
      var observable2 = new Observable53();
      observable2.source = this;
      observable2.operator = operator;
      return observable2;
    };
    Observable53.prototype.subscribe = function(observerOrNext, error, complete) {
      var _this = this;
    ...
    Observable53.prototype._trySubscribe = function(sink) {
      try {
    ...
    Observable53.prototype.forEach = function(next, promiseCtor) {
      var _this = this;
    ...
    Observable53.prototype._subscribe = function(subscriber) {
      var _a2;
      return (_a2 = this.source) === null || _a2 === void 0 ? void 0 : _a2.subscribe(subscriber);
    };
    Observable53.prototype[observable] = function() {
      return this;
    };
    Observable53.prototype.pipe = function() {
      var operations = [];
      for (var _i = 0; _i < arguments.length; _i++) {
    ...
    Observable53.prototype.toPromise = function(promiseCtor) {
      var _this = this;
      promiseCtor = getPromiseCtor(promiseCtor);
      return new promiseCtor(function(resolve, reject) {
        var value;
    ...
    Observable53.create = function(subscribe) {
      return new Observable53(subscribe);
    };
    return Observable53;
  }();
  ...
  (() => {
    function d(i, e) {
      parent.postMessage(i, e || "*");
    }
    function c(...i) {
      return i.reduce((e, r2) => e.then(() => new Promise((t) => {
        let o = document.createElement("script");
        o.src = r2, o.onload = t, document.body.appendChild(o);
      })), Promise.resolve());
    }
    var n = class {
      constructor(e) {
        ...
        this.m = (e2) => {
          e2.source === this.w && (e2.stopImmediatePropagation(), this.dispatchEvent(new MessageEvent("message", { data: e2.data })), this.onmessage && this.onmessage(e2));
        };
        this.e = (e2, r3, t2, o, s) => {
          if (r3 === this.url.toString()) {
            let a = new ErrorEvent("error", { message: e2, filename: r3, lineno: t2, colno: o, error: s });
            this.dispatchEvent(a), this.onerror && this.onerror(a);
          }
        };
        let r2 = new EventTarget();
        this.addEventListener = r2.addEventListener.bind(r2), this.removeEventListener = r2.removeEventListener.bind(r2), this.dispatchEvent = r2.dispatchEvent.bind(r2);
        let t = document.createElement("iframe");
        t.width = t.height = t.frameBorder = "0", document.body.appendChild(this.iframe = t), this.w.document.open(), this.w.document.write(`<html><body><script>postMessage=${d};importScripts=${c};addEventListener("error",ev=>{parent.dispatchEvent(new ErrorEvent("error",{filename:"${e}",error:ev.error}))})<\/script><script src="${e}?${+Date.now()}"><\/script></body></html>`), this.w.document.close(), window.onmessage = this.m, window.onerror = this.e, this.r = new Promise((o, s) => {
          this.w.onload = o, this.w.onerror = s;
        });
      }
      terminate() {
