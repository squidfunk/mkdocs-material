...
will be local to the environment. It's trivial to set up. If you run into 
problems, you can just delete and recreate the environment.
...
Following the instructions below, you will set up a skeleton project to create a 
minimal reproduction. As mentioned above, we recommend using a
[virtual environment], so create a new folder in your working directory and a 
new virtual environment inside it. Next:
...
```
INFO     -  Started archive creation for a bug report
