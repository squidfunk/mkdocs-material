...
=== ":octicons-file-code-16: `docs/javascripts/feedback.js`"
    ...
    feedback.addEventListener("submit", function(ev) {
      ...
      feedback.firstElementChild.disabled = true // (3)!
    ...
    2.  Replace this with the code that sends the data off to your analytics
        provider.

    3.  Disable the form after submission.

    4.  Show the configured notes. Which one is shown depends on the user
        feedback.
