...
#Medication Management for People with Asthma - Prescribing

| Attribute | Description |
| --------- | ----------- |
| **Official Name** | Medication Management for People with Asthma - Prescribing |
| **Long Display Name** | Medication Management for People with Asthma (Prescribing Version) |
| **Short Display Name** | Asthma Prescribing Management |
...
| | AND | D2 | Patient had evidence of persistent asthma during the year before period end (see below for definition of "evidence of persistent asthma") |
| | AND | D3 | Patient had evidence of persistent asthma between 1 and 2 years before period end (see below for definition of "evidence of persistent asthma") |
| | AND | D4 | Patient had BCBS Pharmacy Benefit Coverage for the entire measurement period and the year prior |
...
| | Value Sets | | D2: HEDIS Asthma, HEDIS ED, HEDIS Acute Inpatient, HEDIS Outpatient, HEDIS Observation, NCQA Asthma Medications - Oral (Table MMA-A), NCQA Asthma Medications - Inhaler and Injection (Table MMA-A), NCQA Asthma Medications - Non-Leukotriene Modifier, Non-Antibody Inhibitor (Table MMA-A)<br>D3: HEDIS Asthma, HEDIS ED, HEDIS Acute Inpatient, HEDIS Outpatient, HEDIS Observation, NCQA Asthma Medications - Oral (Table MMA-A), NCQA Asthma Medications - Inhaler and Injection (Table MMA-A), NCQA Asthma Medications - Non-Leukotriene Modifier, Non-Antibody Inhibitor (Table MMA-A)<br>D5: HEDIS Outpatient CPT |
...
| | OR | EX7 | Patient had no asthma controller medications prescribed during the year before period end |
