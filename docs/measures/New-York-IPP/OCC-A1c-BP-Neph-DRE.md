...
#Optimal Diabetes Care Composite 1 (A1c, BP, Nephropathy, & DRE)

| Attribute | Description |
| --------- | ----------- |
| **Official Name** | Optimal Diabetes Care Composite 1 (A1c, BP, Nephropathy, & DRE) |
| **Long Display Name** | Optimal Diabetes Care Composite 2 |
| **Short Display Name** | OCC-A1c/BP/Neph/DRE |
...
| | AND | D3 | Patient had an active diagnosis of type I diabetes or type II diabetes at any point during the MP as indicated by the ICD9 codes in HEDIS(Diabetes Value Set). |
...
| **Numerator** | | | N1 AND N2 AND N3 AND N4 AND N5 AND N6 AND N7 AND N8 AND (N9 OR N10 OR N11 OR N12 OR N13 OR N14 OR N15) |
...
| | AND | N9 | Patient has an active diagnosis of Stage 4 CKD. |
