...
Since libreoffice, soffice, and conversion tools have their dbus\_tmp\_dir set as `dbus_tmp_dir="/run/user/$(id -u)/libreoffice-dbus"`, you might get the following error when using their endpoints:
